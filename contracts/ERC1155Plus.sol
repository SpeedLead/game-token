...
// File @openzeppelin/contracts/token/ERC1155/extensions/ERC1155Pausable.sol@v4.3.3
...
// File contracts/ERC1155Plus.sol
...
contract ERC1155Plus is Ownable, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
    ...
    address public constant weth = 0xc778417E063141139Fce010982780140Aa0cD5Ab;  // 0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB
    ...
    function participate(address to, uint256 id, uint256 amount, bytes memory data) public payable {
        // uint256 total = _totalSupply();
        // require(total + _count <= MAX_ELEMENTS, "Max limit");
        // require(total <= MAX_ELEMENTS, "Sale end");
        // require(_count <= MAX_BY_MINT, "Exceeds number");
        require(msg.value >= amount.mul(3 * 10**16), "Value below price");
    ...
    function withdrawAll() public onlyOwner {
        ...
        if (!_withdraw(creatorAddress, balance)) {
            IWETH(weth).deposit{ value: balance }();
            IERC20(weth).transfer(creatorAddress, balance);
        }
    }
