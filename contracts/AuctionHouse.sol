...
contract AuctionHouse is IAuctionHouse, Pausable, ReentrancyGuard, Ownable {
    ...
    function _createAuction() internal {
        try gameToken.mint(address(this)) returns (uint256 tokenId) {
    ...
    function _settleAuction() internal {
        ...
        if (_auction.bidder == address(0)) {
            gameToken.burn(_auction.tokenId);
        } else {
            gameToken.transferFrom(address(this), _auction.bidder, _auction.tokenId);
        }
